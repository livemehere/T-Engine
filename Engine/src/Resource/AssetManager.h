...
namespace Engine {
    class AssetManager {
    public:
        static Texture* AddTexture(const std::string& name, const std::string& relativePath);
        static Texture* GetTexture(const std::string& name);
        static void ClearTexture(const std::string& name);
        static void ClearTextureAll();

        static Shader* AddShader(const std::string& name, const std::string& vertexShaderPath, const std::string& fragShaderPath);
